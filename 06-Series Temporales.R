AAPL = read.csv("data/Tema 6/AAPL.csv", stringsAsFactors = F)
AMZN = read.csv("data/Tema 6/AMZN.csv", stringsAsFactors = F)
FB = read.csv("data/Tema 6/FB.csv", stringsAsFactors = F)
GOOG = read.csv("data/Tema 6/GOOG.csv", stringsAsFactors = F)
